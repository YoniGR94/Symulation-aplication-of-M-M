...
grams_op_2<- c(25,150,250,500,750,1000)

mega_snack_2<- mega_snack_open(30,grams_op_2,2:10)
...
mega_snack_2 %>% ggplot(aes(x= n_color, y= even_count/n_color, color=color_No2 ))+
  geom_smooth(se= F)+
  scale_color_manual(values = c("coral4", "blue2"))+
  labs(title = "Colors Evens Regression",
       subtitle = "probability of all distinct color of lentils been even using smooth lines",
       x = "No. colors",
       y = "even count Percent",
       color = "No. colors even") +
  theme_bw()
```

Like the previous regression, the second regression that examines the correlation of the number of colors and package size to the percentage of even numbers did not find a statistically significant correlation.
