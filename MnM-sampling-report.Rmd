...
mega_snack_2<- mega_snack_open(20,n_unit_op,color_op) %>% 
...
```
From the second regression we can suggest that more colors is correlated with 3.3% less probability of all colors even,
...
This project help me implement the method of simulation on a need— as silly as in might be— and check the business question with wider sight in order to understand the hole story.
